...
namespace UnityGameKit.Runtime
{
    ...
    public sealed class NetworkComponent : GameKitComponent
    {
        ...
        protected override void Awake()
        {
            ...
            m_NetworkManager = GameKitModuleCenter.GetModule<INetworkManager>();
        ...
        private void OnNetworkConnected(object sender, GameKit.Network.NetworkConnectedEventArgs e)
        {
            m_EventComponent.Fire(this, NetworkConnectedEventArgs.Create(e));
        }

        private void OnNetworkClosed(object sender, GameKit.Network.NetworkClosedEventArgs e)
        {
            m_EventComponent.Fire(this, NetworkClosedEventArgs.Create(e));
        }

        private void OnNetworkMissHeartBeat(object sender, GameKit.Network.NetworkMissHeartBeatEventArgs e)
        {
            m_EventComponent.Fire(this, NetworkMissHeartBeatEventArgs.Create(e));
        }

        private void OnNetworkError(object sender, GameKit.Network.NetworkErrorEventArgs e)
        {
            m_EventComponent.Fire(this, NetworkErrorEventArgs.Create(e));
        }

        private void OnNetworkCustomError(object sender, GameKit.Network.NetworkCustomErrorEventArgs e)
        {
