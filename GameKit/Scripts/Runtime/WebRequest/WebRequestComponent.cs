...
namespace UnityGameKit.Runtime
{
    ...
    public sealed class WebRequestComponent : GameKitComponent
    {
        ...
        [SerializeField]
        private string m_WebRequestAgentHelperTypeName = "UnityGameKit.Runtime.UnityWebRequestAgentHelper";
        ...
        protected override void Awake()
        {
            ...
            m_WebRequestManager = GameKitModuleCenter.GetModule<IWebRequestManager>();
        ...
        private void OnWebRequestStart(object sender, GameKit.WebRequest.WebRequestStartEventArgs e)
        {
            m_EventComponent.Fire(this, WebRequestStartEventArgs.Create(e));
        }

        private void OnWebRequestSuccess(object sender, GameKit.WebRequest.WebRequestSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, WebRequestSuccessEventArgs.Create(e));
        }

        private void OnWebRequestFailure(object sender, GameKit.WebRequest.WebRequestFailureEventArgs e)
        {
