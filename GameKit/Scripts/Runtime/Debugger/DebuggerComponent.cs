...
namespace UnityGameKit.Runtime
{
    ...
    public sealed partial class DebuggerComponent : GameKitComponent
    {
        ...
        protected override void Awake()
        {
            ...
            m_DebuggerManager = GameKitModuleCenter.GetModule<IDebuggerManager>();
        ...
        private void OnGUI()
        {
            ...
            if (m_ShowFullWindow)
            {
                m_WindowRect = GUILayout.Window(0, m_WindowRect, DrawWindow, "<b>Game Kit DEBUGGER</b>");
            }
            else
            {
