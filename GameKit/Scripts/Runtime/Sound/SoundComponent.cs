...
namespace UnityGameKit.Runtime
{
    ...
    public sealed partial class SoundComponent : GameKitComponent
    {
        ...
        [SerializeField]
        private string m_SoundHelperTypeName = "UnityGameKit.Runtime.DefaultSoundHelper";

        [SerializeField]
        private SoundHelperBase m_CustomSoundHelper = null;

        [SerializeField]
        private string m_SoundGroupHelperTypeName = "UnityGameKit.Runtime.DefaultSoundGroupHelper";

        [SerializeField]
        private SoundGroupHelperBase m_CustomSoundGroupHelper = null;

        [SerializeField]
        private string m_SoundAgentHelperTypeName = "UnityGameKit.Runtime.DefaultSoundAgentHelper";
        ...
        protected override void Awake()
        {
            ...
            m_SoundManager = GameKitModuleCenter.GetModule<ISoundManager>();
...
#else
            ISceneManager sceneManager = GameKitModuleCenter.GetModule<ISceneManager>();
        ...
        private void Start()
        {
            ...
            {
                m_SoundManager.SetResourceManager(GameKitModuleCenter.GetModule<IResourceManager>());
            }
        ...
        private void OnPlaySoundSuccess(object sender, GameKit.Sound.PlaySoundSuccessEventArgs e)
        {
        ...
        private void OnPlaySoundFailure(object sender, GameKit.Sound.PlaySoundFailureEventArgs e)
        {
        ...
        private void OnPlaySoundUpdate(object sender, GameKit.Sound.PlaySoundUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, PlaySoundUpdateEventArgs.Create(e));
        }

        private void OnPlaySoundDependencyAsset(object sender, GameKit.Sound.PlaySoundDependencyAssetEventArgs e)
        {
