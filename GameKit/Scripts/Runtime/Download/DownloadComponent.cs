...
namespace UnityGameKit.Runtime
{
    ...
    public sealed class DownloadComponent : GameKitComponent
    {
        ...
        [SerializeField]
        private string m_DownloadAgentHelperTypeName = "UnityGameKit.Runtime.UnityWebRequestDownloadAgentHelper";
        ...
        protected override void Awake()
        {
            ...
            m_DownloadManager = GameKitModuleCenter.GetModule<IDownloadManager>();
        ...
        private void OnDownloadStart(object sender, GameKit.Download.DownloadStartEventArgs e)
        {
            m_EventComponent.Fire(this, DownloadStartEventArgs.Create(e));
        }

        private void OnDownloadUpdate(object sender, GameKit.Download.DownloadUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, DownloadUpdateEventArgs.Create(e));
        }

        private void OnDownloadSuccess(object sender, GameKit.Download.DownloadSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, DownloadSuccessEventArgs.Create(e));
        }

        private void OnDownloadFailure(object sender, GameKit.Download.DownloadFailureEventArgs e)
        {
