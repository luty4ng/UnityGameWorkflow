...
namespace UnityGameKit.Runtime
{
    ...
    public sealed partial class UIComponent : GameKitComponent
    {
        ...
        protected override void Awake()
        {
            ...
            m_UIManager = GameKitModuleCenter.GetModule<IUIManager>();
            if (m_UIManager == null)
            {
        ...
        private void OnOpenUIFormUpdate(object sender, GameKit.UI.OpenUIFormUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, OpenUIFormUpdateEventArgs.Create(e));
        }

        private void OnOpenUIFormDependencyAsset(object sender, GameKit.UI.OpenUIFormDependencyAssetEventArgs e)
        {
