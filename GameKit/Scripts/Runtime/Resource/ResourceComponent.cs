...
namespace UnityGameKit.Runtime
{
    ...
    [AddComponentMenu("Game Kit/Resource Component")]
    public sealed class ResourceComponent : GameKitComponent
    {
        ...
        [SerializeField]
        private string m_ResourceHelperTypeName = "UnityGameKit.Runtime.DefaultResourceHelper";

        [SerializeField]
        private ResourceHelperBase m_CustomResourceHelper = null;

        [SerializeField]
        private string m_LoadResourceAgentHelperTypeName = "UnityGameKit.Runtime.DefaultLoadResourceAgentHelper";
        ...
        private void Start()
        {
            ...
            m_ResourceManager = m_EditorResourceMode ? baseComponent.EditorResourceHelper : GameKitModuleCenter.GetModule<IResourceManager>();
            ...
            m_ResourceManager.SetObjectPoolManager(GameKitModuleCenter.GetModule<IObjectPoolManager>());
            m_ResourceManager.SetFileSystemManager(GameKitModuleCenter.GetModule<IFileSystemManager>());
            m_ResourceManager.SetDownloadManager(GameKitModuleCenter.GetModule<IDownloadManager>());
        ...
        private void OnResourceVerifyStart(object sender, GameKit.Resource.ResourceVerifyStartEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceVerifyStartEventArgs.Create(e));
        }

        private void OnResourceVerifySuccess(object sender, GameKit.Resource.ResourceVerifySuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceVerifySuccessEventArgs.Create(e));
        }

        private void OnResourceVerifyFailure(object sender, GameKit.Resource.ResourceVerifyFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceVerifyFailureEventArgs.Create(e));
        }

        private void OnResourceApplyStart(object sender, GameKit.Resource.ResourceApplyStartEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceApplyStartEventArgs.Create(e));
        }

        private void OnResourceApplySuccess(object sender, GameKit.Resource.ResourceApplySuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceApplySuccessEventArgs.Create(e));
        }

        private void OnResourceApplyFailure(object sender, GameKit.Resource.ResourceApplyFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceApplyFailureEventArgs.Create(e));
        }

        private void OnResourceUpdateStart(object sender, GameKit.Resource.ResourceUpdateStartEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateStartEventArgs.Create(e));
        }

        private void OnResourceUpdateChanged(object sender, GameKit.Resource.ResourceUpdateChangedEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateChangedEventArgs.Create(e));
        }

        private void OnResourceUpdateSuccess(object sender, GameKit.Resource.ResourceUpdateSuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateSuccessEventArgs.Create(e));
        }

        private void OnResourceUpdateFailure(object sender, GameKit.Resource.ResourceUpdateFailureEventArgs e)
        {
            m_EventComponent.Fire(this, ResourceUpdateFailureEventArgs.Create(e));
        }

        private void OnResourceUpdateAllComplete(object sender, GameKit.Resource.ResourceUpdateAllCompleteEventArgs e)
        {
