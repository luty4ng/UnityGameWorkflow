...
namespace UnityGameKit.Runtime
{
    ...
    public sealed partial class EntityComponent : GameKitComponent
    {
        ...
        private void Start()
        {
            ...
            {
                m_EntityManager.SetResourceManager(GameKitModuleCenter.GetModule<IResourceManager>());
            }
        ...
        private void OnShowEntitySuccess(object sender, GameKit.Entity.ShowEntitySuccessEventArgs e)
        {
            m_EventComponent.Fire(this, ShowEntitySuccessEventArgs.Create(e));
        }

        private void OnShowEntityFailure(object sender, GameKit.Entity.ShowEntityFailureEventArgs e)
        {
        ...
        private void OnShowEntityUpdate(object sender, GameKit.Entity.ShowEntityUpdateEventArgs e)
        {
            m_EventComponent.Fire(this, ShowEntityUpdateEventArgs.Create(e));
        }

        private void OnShowEntityDependencyAsset(object sender, GameKit.Entity.ShowEntityDependencyAssetEventArgs e)
        {
            m_EventComponent.Fire(this, ShowEntityDependencyAssetEventArgs.Create(e));
        }

        private void OnHideEntityComplete(object sender, GameKit.Entity.HideEntityCompleteEventArgs e)
        {
