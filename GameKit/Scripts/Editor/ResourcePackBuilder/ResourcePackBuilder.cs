...
namespace UnityGameKit.Editor.ResourceTools
{
    ...
    internal sealed class ResourcePackBuilder : EditorWindow
    {
        ...
        [MenuItem("Game Kit/Resource Tools/Resource Pack Builder", false, 43)]
        ...
        private void OnGUI()
        {
            EditorGUILayout.BeginVertical(GUILayout.Width(position.width), GUILayout.Height(position.height));
            {
                ...
                EditorGUILayout.BeginVertical("box");
                {
                    ...
                    EditorGUILayout.BeginHorizontal();
                    {
                        EditorGUILayout.LabelField("Game Kit Version", GUILayout.Width(160f));
                        EditorGUILayout.LabelField(m_Controller.GameKitVersion);
                    }
                    EditorGUILayout.EndHorizontal();
                    EditorGUILayout.BeginHorizontal();
                    {
