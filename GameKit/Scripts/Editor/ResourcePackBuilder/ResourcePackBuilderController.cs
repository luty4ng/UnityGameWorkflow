...
namespace UnityGameKit.Editor.ResourceTools
{
    ...
    {
        private const string DefaultResourcePackName = "GameKitResourcePack";
        ...
        public event GameKitAction<int> OnBuildResourcePacksStarted = null;

        public event GameKitAction<int, int> OnBuildResourcePacksCompleted = null;

        public event GameKitAction<int, int, string, string> OnBuildResourcePackSuccess = null;

        public event GameKitAction<int, int, string, string> OnBuildResourcePackFailure = null;
        ...
        public string[] GetVersionNames()
        {
            ...
            foreach (DirectoryInfo directoryInfo in sourceDirectoryInfo.GetDirectories())
            {
                ...
                FileInfo[] versionListFiles = platformDirectoryInfo.GetFiles("GameKitVersion.*.dat", SearchOption.TopDirectoryOnly);
        ...
        public bool BuildResourcePack(string sourceVersion, string targetVersion)
        {
            try
            {
                ...
                if (sourceVersion != null)
                {
                    ...
                    FileInfo[] sourceVersionListFiles = sourceDirectoryInfo.GetFiles("GameKitVersion.*.dat", SearchOption.TopDirectoryOnly);
                ...
                FileInfo[] targetVersionListFiles = targetDirectoryInfo.GetFiles("GameKitVersion.*.dat", SearchOption.TopDirectoryOnly);
