...
namespace UnityGameKit.Editor
{
    ...
    internal static class BuildSettings
    {
        ...
        {
            s_ConfigurationPath = Type.GetConfigurationPath<BuildSettingsConfigPathAttribute>() ?? Utility.Path.GetRegularPath(Path.Combine(Application.dataPath, "GameKit/Configs/BuildSettings.xml"));
        ...
        /// 将构建场景设置为默认。
        /// </summary>
        [MenuItem("Game Kit/Scenes in Build Settings/Default Scenes", false, 20)]
        ...
        /// 将构建场景设置为所有。
        /// </summary>
        [MenuItem("Game Kit/Scenes in Build Settings/All Scenes", false, 21)]
