...
namespace UnityGameKit.Editor
{
    ...
    public static class OpenFolder
    {
        ...
        /// 打开 Data Path 文件夹。
        /// </summary>
        [MenuItem("Game Kit/Open Folder/Data Path", false, 10)]
        ...
        /// </summary>
        [MenuItem("Game Kit/Open Folder/Persistent Data Path", false, 11)]
        ...
        /// </summary>
        [MenuItem("Game Kit/Open Folder/Streaming Assets Path", false, 12)]
        ...
        /// </summary>
        [MenuItem("Game Kit/Open Folder/Temporary Cache Path", false, 13)]
        ...
        /// </summary>
        [MenuItem("Game Kit/Open Folder/Console Log Path", false, 14)]
        ...
        public static void Execute(string folder)
        {
            ...
            switch (Application.platform)
            {
                ...
                default:
                    throw new GameKitException(Utility.Text.Format("Not support open folder on '{0}' platform.", Application.platform));
            }
        }
    }
}
