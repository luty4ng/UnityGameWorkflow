...
namespace UnityGameKit.Editor.ResourceTools
{
    public sealed class SourceFolder
    {
        ...
        public SourceFolder GetFolder(string name)
        {
            ...
            {
                throw new GameKitException("Source folder name is invalid.");
            }
        ...
        public SourceFolder AddFolder(string name)
        {
            ...
            if (folder != null)
            {
                throw new GameKitException("Source folder is already exist.");
            }
        ...
        public SourceAsset GetAsset(string name)
        {
            if (string.IsNullOrEmpty(name))
            {
                throw new GameKitException("Source asset name is invalid.");
            }
        ...
        public SourceAsset AddAsset(string guid, string path, string name)
        {
            ...
            {
                throw new GameKitException("Source asset guid is invalid.");
            }

            if (string.IsNullOrEmpty(path))
            {
                throw new GameKitException("Source asset path is invalid.");
            }
            ...
            if (asset != null)
            {
                throw new GameKitException(Utility.Text.Format("Source asset '{0}' is already exist.", name));
            }
