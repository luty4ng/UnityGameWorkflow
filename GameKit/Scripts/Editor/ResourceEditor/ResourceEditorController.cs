...
namespace UnityGameKit.Editor.ResourceTools
{
    public sealed class ResourceEditorController
    {
        ...
        {
            m_ConfigurationPath = Type.GetConfigurationPath<ResourceEditorConfigPathAttribute>() ?? Utility.Path.GetRegularPath(Path.Combine(Application.dataPath, "GameKit/Configs/ResourceEditor.xml"));
        ...
        public event GameKitAction<SourceAsset[]> OnAssetAssigned = null;

        public event GameKitAction<SourceAsset[]> OnAssetUnassigned = null;
