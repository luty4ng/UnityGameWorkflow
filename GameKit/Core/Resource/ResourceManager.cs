...
namespace GameKit.Resource
{
    ...
    {
        private const string RemoteVersionListFileName = "GameKitVersion.dat";
        private const string LocalVersionListFileName = "GameKitList.dat";
        ...
        public int GenerateReadWriteVersionListLength
        {
            ...
            set
            {
                ...
                {
                    throw new GameKitException("You can not use GenerateReadWriteVersionListLength at this time.");
                }
        ...
        public int UpdateRetryCount
        {
            ...
            set
            {
                if (m_ResourceUpdater == null)
                {
                    throw new GameKitException("You can not use UpdateRetryCount at this time.");
                }
        ...
        public void SetReadOnlyPath(string readOnlyPath)
        {
            ...
            {
                throw new GameKitException("Read-only path is invalid.");
            }

            if (m_RefuseSetFlag)
            {
                throw new GameKitException("You can not set read-only path at this time.");
            }

            if (m_ResourceLoader.TotalAgentCount > 0)
            {
                throw new GameKitException("You must set read-only path before add load resource agent helper.");
            }
        ...
        public void SetReadWritePath(string readWritePath)
        {
            ...
            {
                throw new GameKitException("Read-write path is invalid.");
            }

            if (m_RefuseSetFlag)
            {
                throw new GameKitException("You can not set read-write path at this time.");
            }

            if (m_ResourceLoader.TotalAgentCount > 0)
            {
                throw new GameKitException("You must set read-write path before add load resource agent helper.");
            }
        ...
        public void SetResourceMode(ResourceMode resourceMode)
        {
            ...
            {
                throw new GameKitException("Resource mode is invalid.");
            }

            if (m_RefuseSetFlag)
            {
                throw new GameKitException("You can not set resource mode at this time.");
            }
            ...
            {
                throw new GameKitException("You can not change resource mode at this time.");
            }
        }
        ...
        public void SetCurrentVariant(string currentVariant)
        {
            if (m_RefuseSetFlag)
            {
                throw new GameKitException("You can not set current variant at this time.");
            }
        ...
        public void SetFileSystemManager(IFileSystemManager fileSystemManager)
        {
            ...
            {
                throw new GameKitException("File system manager is invalid.");
            }
        ...
        public void SetDownloadManager(IDownloadManager downloadManager)
        {
            ...
            {
                throw new GameKitException("Download manager is invalid.");
            }
        ...
        public void SetDecryptResourceCallback(DecryptResourceCallback decryptResourceCallback)
        {
            if (m_ResourceLoader.TotalAgentCount > 0)
            {
                throw new GameKitException("You must set decrypt resource callback before add load resource agent helper.");
            }
        ...
        public void SetResourceHelper(IResourceHelper resourceHelper)
        {
            ...
            {
                throw new GameKitException("Resource helper is invalid.");
            }

            if (m_ResourceLoader.TotalAgentCount > 0)
            {
                throw new GameKitException("You must set resource helper before add load resource agent helper.");
            }
        ...
        public void InitResources(InitResourcesCompleteCallback initResourcesCompleteCallback)
        {
            ...
            {
                throw new GameKitException("Init resources complete callback is invalid.");
            }

            if (m_ResourceMode == ResourceMode.Unspecified)
            {
                throw new GameKitException("You must set resource mode first.");
            }

            if (m_ResourceMode != ResourceMode.Package)
            {
                throw new GameKitException("You can not use InitResources without package resource mode.");
            }

            if (m_ResourceIniter == null)
            {
                throw new GameKitException("You can not use InitResources at this time.");
            }
        ...
        public CheckVersionListResult CheckVersionList(int latestInternalResourceVersion)
        {
            ...
            {
                throw new GameKitException("You can not use CheckVersionList without updatable resource mode.");
            }

            if (m_VersionListProcessor == null)
            {
                throw new GameKitException("You can not use CheckVersionList at this time.");
            }
        ...
        public void UpdateVersionList(int versionListLength, int versionListHashCode, int versionListCompressedLength, int versionListCompressedHashCode, UpdateVersionListCallbacks updateVersionListCallbacks)
        {
            ...
            {
                throw new GameKitException("Update version list callbacks is invalid.");
            }
            ...
            if (m_ResourceMode != ResourceMode.Updatable && m_ResourceMode != ResourceMode.UpdatableWhilePlaying)
            {
                throw new GameKitException("You can not use UpdateVersionList without updatable resource mode.");
            }

            if (m_VersionListProcessor == null)
            {
                throw new GameKitException("You can not use UpdateVersionList at this time.");
            }
        ...
        public void VerifyResources(int verifyResourceLengthPerFrame, VerifyResourcesCompleteCallback verifyResourcesCompleteCallback)
        {
            ...
            {
                throw new GameKitException("Verify resources complete callback is invalid.");
            }
            ...
            if (m_ResourceMode != ResourceMode.Updatable && m_ResourceMode != ResourceMode.UpdatableWhilePlaying)
            {
                throw new GameKitException("You can not use VerifyResources without updatable resource mode.");
            }

            if (m_RefuseSetFlag)
            {
                throw new GameKitException("You can not verify resources at this time.");
            }
        ...
        public void CheckResources(bool ignoreOtherVariant, CheckResourcesCompleteCallback checkResourcesCompleteCallback)
        {
            ...
            {
                throw new GameKitException("Check resources complete callback is invalid.");
            }
            ...
            if (m_ResourceMode != ResourceMode.Updatable && m_ResourceMode != ResourceMode.UpdatableWhilePlaying)
            {
                throw new GameKitException("You can not use CheckResources without updatable resource mode.");
            }

            if (m_ResourceChecker == null)
            {
                throw new GameKitException("You can not use CheckResources at this time.");
            }
        ...
        public void ApplyResources(string resourcePackPath, ApplyResourcesCompleteCallback applyResourcesCompleteCallback)
        {
            ...
            {
                throw new GameKitException("Resource pack path is invalid.");
            }

            if (!File.Exists(resourcePackPath))
            {
                throw new GameKitException(Utility.Text.Format("Resource pack '{0}' is not exist.", resourcePackPath));
            }

            if (applyResourcesCompleteCallback == null)
            {
                throw new GameKitException("Apply resources complete callback is invalid.");
            }
            ...
            if (m_ResourceMode != ResourceMode.Updatable && m_ResourceMode != ResourceMode.UpdatableWhilePlaying)
            {
                throw new GameKitException("You can not use ApplyResources without updatable resource mode.");
            }

            if (m_ResourceUpdater == null)
            {
                throw new GameKitException("You can not use ApplyResources at this time.");
            }
        ...
        public void UpdateResources(string resourceGroupName, UpdateResourcesCompleteCallback updateResourcesCompleteCallback)
        {
            ...
            {
                throw new GameKitException("Update resources complete callback is invalid.");
            }
            ...
            if (m_ResourceMode != ResourceMode.Updatable && m_ResourceMode != ResourceMode.UpdatableWhilePlaying)
            {
                throw new GameKitException("You can not use UpdateResources without updatable resource mode.");
            }

            if (m_ResourceUpdater == null)
            {
                throw new GameKitException("You can not use UpdateResources at this time.");
            }

            ResourceGroup resourceGroup = (ResourceGroup)GetResourceGroup(resourceGroupName);
            if (resourceGroup == null)
            {
                throw new GameKitException(Utility.Text.Format("Can not find resource group '{0}'.", resourceGroupName));
            }
        ...
        public void StopUpdateResources()
        {
            ...
            if (m_ResourceMode != ResourceMode.Updatable && m_ResourceMode != ResourceMode.UpdatableWhilePlaying)
            {
                throw new GameKitException("You can not use StopUpdateResources without updatable resource mode.");
            }

            if (m_ResourceUpdater == null)
            {
                throw new GameKitException("You can not use StopUpdateResources at this time.");
            }
        ...
        public bool VerifyResourcePack(string resourcePackPath)
        {
            ...
            if (m_ResourceMode != ResourceMode.Updatable && m_ResourceMode != ResourceMode.UpdatableWhilePlaying)
            {
                throw new GameKitException("You can not use VerifyResourcePack without updatable resource mode.");
            }

            if (m_ResourcePackVersionListSerializer == null)
            {
                throw new GameKitException("You can not use VerifyResourcePack at this time.");
            }
        ...
        public HasAssetResult HasAsset(string assetName)
        {
            ...
            {
                throw new GameKitException("Asset name is invalid.");
            }
        ...
        public void LoadAsset(string assetName, LoadAssetCallbacks loadAssetCallbacks)
        {
            ...
            {
                throw new GameKitException("Load asset callbacks is invalid.");
            }
        ...
        /// <summary>
        /// 卸载资源。
        /// </summary>SetCurrentVariant
        /// <param name="asset">要卸载的资源。</param>
        public void UnloadAsset(object asset)
        {
            if (asset == null)
            {
                throw new GameKitException("Asset is invalid.");
            }
        ...
        public void LoadScene(string sceneAssetName, LoadSceneCallbacks loadSceneCallbacks)
        {
            ...
            {
                throw new GameKitException("Load scene callbacks is invalid.");
            }
        ...
        public void UnloadScene(string sceneAssetName, UnloadSceneCallbacks unloadSceneCallbacks)
        {
            ...
            {
                throw new GameKitException("Unload scene callbacks is invalid.");
            }
        ...
        public string GetBinaryPath(string binaryAssetName)
        {
            ...
            {
                throw new GameKitException("Binary asset name is invalid.");
            }
        ...
        public void LoadBinary(string binaryAssetName, LoadBinaryCallbacks loadBinaryCallbacks)
        {
            ...
            {
                throw new GameKitException("Load binary callbacks is invalid.");
            }
        ...
        public int LoadBinaryFromFileSystem(string binaryAssetName, byte[] buffer)
        {
            ...
            if (buffer == null)
            {
                throw new GameKitException("Buffer is invalid.");
            }
        ...
        public IResourceGroupCollection GetResourceGroupCollection(params string[] resourceGroupNames)
        {
            ...
            {
                throw new GameKitException("Resource group names is invalid.");
            }
            ...
            for (int i = 0; i < resourceGroupNames.Length; i++)
            {
                ...
                {
                    throw new GameKitException("Resource group name is invalid.");
                }

                resourceGroups[i] = (ResourceGroup)GetResourceGroup(resourceGroupNames[i]);
                if (resourceGroups[i] == null)
                {
                    throw new GameKitException(Utility.Text.Format("Resource group '{0}' is not exist.", resourceGroupNames[i]));
                }
            }
        ...
        private IFileSystem GetFileSystem(string fileSystemName, bool storageInReadOnly)
        {
            ...
            {
                throw new GameKitException("File system name is invalid.");
            }
