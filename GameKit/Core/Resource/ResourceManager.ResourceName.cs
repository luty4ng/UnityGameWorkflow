    ...
    internal sealed partial class ResourceManager : GameKitModule, IResourceManager
    {
        ...
        private struct ResourceName : IComparable, IComparable<ResourceName>, IEquatable<ResourceName>
        {
            ...
            public ResourceName(string name, string variant, string extension)
            {
                ...
                {
                    throw new GameKitException("Resource name is invalid.");
                }

                if (string.IsNullOrEmpty(extension))
                {
                    throw new GameKitException("Resource extension is invalid.");
                }
            ...
            public int CompareTo(object value)
            {
                ...
                {
                    throw new GameKitException("Type of value is invalid.");
                }
