...
namespace GameKit.Resource
{
    internal sealed partial class ResourceManager : GameKitModule, IResourceManager
    {
        ...
        private sealed partial class ResourceVerifier
        {
            ...
            public GameKitAction<int, long> ResourceVerifyStart;
            public GameKitAction<ResourceName, int> ResourceVerifySuccess;
            public GameKitAction<ResourceName> ResourceVerifyFailure;
            public GameKitAction<bool> ResourceVerifyComplete;
            ...
            public void VerifyResources(int verifyResourceLengthPerFrame)
            {
                ...
                {
                    throw new GameKitException("Verify resource count per frame is invalid.");
                }
