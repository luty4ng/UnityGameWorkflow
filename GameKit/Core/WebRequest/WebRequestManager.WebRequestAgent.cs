namespace GameKit.WebRequest
{
    internal sealed partial class WebRequestManager : GameKitModule, IWebRequestManager
    {
        ...
        private sealed class WebRequestAgent : ITaskAgent<WebRequestTask>
        {
            ...
            public GameKitAction<WebRequestAgent> WebRequestAgentStart;
            public GameKitAction<WebRequestAgent, byte[]> WebRequestAgentSuccess;
            public GameKitAction<WebRequestAgent, string> WebRequestAgentFailure;
            ...
            public WebRequestAgent(IWebRequestAgentHelper webRequestAgentHelper)
            {
                ...
                {
                    throw new GameKitException("Web request agent helper is invalid.");
                }
