...
namespace GameKit.Download
{
    internal sealed partial class DownloadManager : GameKitModule, IDownloadManager
    {
        ...
        private sealed class DownloadAgent : ITaskAgent<DownloadTask>, IDisposable
        {
            ...
            public GameKitAction<DownloadAgent> DownloadAgentStart;
            public GameKitAction<DownloadAgent, int> DownloadAgentUpdate;
            public GameKitAction<DownloadAgent, long> DownloadAgentSuccess;
            public GameKitAction<DownloadAgent, string> DownloadAgentFailure;
            ...
            public DownloadAgent(IDownloadAgentHelper downloadAgentHelper)
            {
                ...
                {
                    throw new GameKitException("Download agent helper is invalid.");
                }
            ...
            private void OnDownloadAgentHelperComplete(object sender, DownloadAgentHelperCompleteEventArgs e)
            {
                ...
                {
                    throw new GameKitException("Internal download error.");
                }
