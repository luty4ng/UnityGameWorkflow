...
namespace GameKit.Network
{
    internal sealed partial class NetworkManager : GameKitModule, INetworkManager
    {
        ...
        private abstract class NetworkChannelBase : INetworkChannel, IDisposable
        {
            ...
            public GameKitAction<NetworkChannelBase, object> NetworkChannelConnected;
            public GameKitAction<NetworkChannelBase> NetworkChannelClosed;
            public GameKitAction<NetworkChannelBase, int> NetworkChannelMissHeartBeat;
            public GameKitAction<NetworkChannelBase, NetworkErrorCode, SocketError, string> NetworkChannelError;
            public GameKitAction<NetworkChannelBase, object> NetworkChannelCustomError;
            ...
            public void RegisterHandler(IPacketHandler handler)
            {
                if (handler == null)
                {
                    throw new GameKitException("Packet handler is invalid.");
                }
