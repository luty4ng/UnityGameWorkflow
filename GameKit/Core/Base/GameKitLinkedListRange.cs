...
namespace GameKit
{
    ...
    public struct GameKitLinkedListRange<T> : IEnumerable<T>, IEnumerable
    {
        ...
        public GameKitLinkedListRange(LinkedListNode<T> first, LinkedListNode<T> terminal)
        {
        ...
        {
            private readonly GameKitLinkedListRange<T> m_GameKitLinkedListRange;
            private LinkedListNode<T> m_Current;
            private T m_CurrentValue;

            internal Enumerator(GameKitLinkedListRange<T> range)
            {
                if (!range.IsValid)
                {
                    throw new GameKitException("Range is invalid.");
                ...
                m_GameKitLinkedListRange = range;
                m_Current = m_GameKitLinkedListRange.m_First;
            ...
            {
                if (m_Current == null || m_Current == m_GameKitLinkedListRange.m_Terminal)
                {
                    return false;
                }
