...
namespace GameKit
{
    ...
    public sealed class GameKitLinkedList<T> : ICollection<T>, IEnumerable<T>, ICollection, IEnumerable
    {
        ...
        public void RemoveFirst()
        {
            ...
            if (first == null)
            {
                throw new GameKitException("First is invalid.");
            }
        ...
        public void RemoveLast()
        {
            ...
            if (last == null)
            {
                throw new GameKitException("Last is invalid.");
            }
        ...
        public struct Enumerator : IEnumerator<T>, IEnumerator
        {
            ...
            internal Enumerator(LinkedList<T> linkedList)
            {
                if (linkedList == null)
                {
                    throw new GameKitException("Linked list is invalid.");
                }
